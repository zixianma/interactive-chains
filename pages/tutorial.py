...
def begin_tutorial():
    ...
    if show_transition(
        stage_key="tutorial_transition_done",
        stage_title="Screen Recording Tutorial",
        instructions=(
            "In the next stage, you'll complete a short tutorial on how to record your screen during the study. "
            "Please follow the instructions carefully, as you will be required to upload the recorded video at the end of the study to complete your participation. "
            "Ensure you fully understand how to record your screen before proceeding."
        ),
        button_label="Proceed to Tutorial"
    ):
        return

...
def begin_tutorial():
    ...
    if st.session_state['tutorial_idx'] < num_tutorial_screenshots:
        ...
        st.markdown("### :red[IMPORTANT! Before you begin answering the questions, please follow the steps below to start a recording of your screen. You will need to upload the recording at the end to complete the study.]")

...
def login():
    ...
    if 'username' not in st.session_state or st.session_state.username == '': 
        ...
        st.write("TIME INVOLVEMENT: Your participation will take approximately 45 minutes.\n")
        st.write("PAYMENTS: You will receive \$11.25 via Prolific upon completion of the study, and you will receive additional compensation of \$0.10 per correct answer afterwards, as payment for your participation. A total of up to $3 in bonuses is available.\n")

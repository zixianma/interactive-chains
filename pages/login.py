...
def submit_consent(username_input):
    if not username_input or username_input == "":
        ...
        st.session_state.page =  "demographics" #"tutorial" #"instruction" "survey" "main_study" 
...
def login():
    ...
    if 'username' not in st.session_state or st.session_state.username == '': 
        ...
        st.write("You are invited to participate in a research study on AI-assisted question answering. You will be asked to verify claims and answer multiple choice questions with the help of an AI model. You will not be recorded via audio or video.\n")
        st.write("TIME INVOLVEMENT: Your participation will take approximately 30 minutes.\n")
        st.write("PAYMENTS: You will receive \$7.5 via Prolific upon completion of the study, and you will receive additional compensation of \$0.10 per correct answer afterwards, as payment for your participation. A total of up to $3 in bonuses is available.\n")

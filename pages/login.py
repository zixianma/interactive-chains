...
def login():
    ...
    if 'username' not in st.session_state or st.session_state.username == '': 
        ...
        st.write("PAYMENTS: You will receive \$12 via Prolific upon completion of the study, and you will receive additional compensation of \$0.5 per correct answer afterwards, as payment for your participation. A total of up to \$6 in bonuses is available.\n")

    ...
    if not username_input or username_input == "":
        ...
        if 'sheet' not in st.session_state:
            ...
            if user_condition:
                ...
                all_values = exponential_backoff(st.session_state['user_worksheet'].get, 'J2:J17') ## need to change to current set up
                ...
                eval_worksheet = ensure_eval_worksheet()
                ...
                if 'evaluation' not in st.session_state:
                    st.session_state['evaluation'] = eval_worksheet
...
def login():
    ...
    if 'username' not in st.session_state or st.session_state.username == '': 
        ...
        st.write("""
            You are invited to participate in a research study on AI-assisted decision making.
            We will begin by asking you to solve 4 math problems to evaluate your abilities. You must answer most of them correctly in order to proceed with the study.
            Then in the main study, you will review answers generated by an AI model and decide whether to **ACCEPT** or **REJECT** each answer based on the information provided.
        """)
        ...
        st.write("PAYMENTS: You will receive \$15 via Prolific upon completion of the study, and you will receive additional compensation of \$0.25 per correct answer afterwards, as payment for your participation. A total of up to \$5 in bonuses is available.\n")
